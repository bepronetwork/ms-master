...
import { BITGO_ACCESS_TOKEN, IS_DEVELOPMENT, BITGO_ENTERPRISE_ID, MS_MASTER_URL } from '../../../config';
import { normalizePolicy, getCurrencyAmountFromBitGo } from './helpers';

class BitGoClass {
    constructor(){
        this.bitgo = new BitGo.BitGo({ accessToken: BITGO_ACCESS_TOKEN }); // defaults to testnet. add env: 'prod' if you want to go against mainnet
    }
