...
import { AppRepository, ProviderTokenRepository } from '../db/repos';
...
class ProviderTokenLogic extends LogicComponent {
    constructor(scope) {
        super(scope);
        self = this;
        __private = {
...
export default ProviderTokenLogic;